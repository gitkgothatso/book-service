...
@UnitTest
class BookServiceAppCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class BookServiceAppCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = BookServiceAppCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = BookServiceAppCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class BookServiceAppCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = BookServiceAppCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = BookServiceAppCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class BookServiceAppCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = BookServiceAppCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = BookServiceAppCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class BookServiceAppMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = BookServiceAppCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = BookServiceAppCollections.immutable(input);
