package com.itstudio.bookservice.wire.springdoc.infrastructure.primary;
...
class SpringdocConfiguration {
  ...
  @Bean
  public OpenAPI bookServiceAppOpenAPI() {
  ...
  @Bean
  public GroupedOpenApi bookServiceAppAllOpenAPI() {
